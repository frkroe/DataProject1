...
def insert_clientes():
    with open('../DatosLimpios/clientes.csv', newline='',  encoding="utf8") as csvfile:
...
def insert_influencers():
    with open('../DatosLimpios/influencer.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
...
def insert_categoria():
    with open('../DatosLimpios/categoria.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
...
def insert_composicion():
    with open('../DatosLimpios/composicion.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
...
def insert_mueble_composicion():
    with open('../DatosLimpios/mueble_composicion.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
...
def insert_muebles():
    with open('../DatosLimpios/muebles.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
...
def insert_ventas():
    with open('../DatosLimpios/ventas.csv', newline='',  encoding="utf8") as csvfile:
        spamreader = csv.reader(csvfile)
        for row in spamreader:
